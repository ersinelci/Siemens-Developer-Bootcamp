...
abstract class BaseVehicle {
    ...
    setRightorLeft(rightBehavior:IRightBehavior, leftBehavior:ILeftBehavior){
        this._rightBehavior=rightBehavior;
        this._leftBehavior=leftBehavior;
    }
    Forward():void{console.log("İleri!")}
    Backward():void{console.log("Geri!")}
    Right():void{this._rightBehavior.Right();}
    Left():void{this._leftBehavior.Left();}
}
