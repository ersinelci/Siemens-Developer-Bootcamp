...
var LeftBehaviorType3 = /** @class */ (function () {
    function LeftBehaviorType3() {
    }
    LeftBehaviorType3.prototype.Left = function () {
        console.log("left type 3");
    };
    return LeftBehaviorType3;
}());
var BaseVehicle = /** @class */ (function () {
    ...
    BaseVehicle.prototype.setRightorLeft = function (rightBehavior, leftBehavior) {
        this._rightBehavior = rightBehavior;
        this._leftBehavior = leftBehavior;
    };
    BaseVehicle.prototype.Forward = function () { console.log("İleri!"); };
    BaseVehicle.prototype.Backward = function () { console.log("Geri!"); };
    BaseVehicle.prototype.Right = function () { this._rightBehavior.Right(); };
    BaseVehicle.prototype.Left = function () { this._leftBehavior.Left(); };
    return BaseVehicle;
}());
...
c1.Right();
c1.Left();
c1.setRightorLeft(new RightBehaviorType1(), new LeftBehaviorType1());
c1.Right();
c1.Left();
